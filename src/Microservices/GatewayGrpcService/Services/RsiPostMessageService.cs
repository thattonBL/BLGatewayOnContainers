...
{
    public class RsiPostMessageService : Protos.GatewayGrpcService.GatewayGrpcServiceBase
    {
        private readonly IGatewayRequestQueries _gatewayRequestQueries;
        
        public RsiPostMessageService(IGatewayRequestQueries gatewayRequestQueries)
        {
